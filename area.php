...
$arrField = array('*');
$arrRecords = $objControl->getRecords('area_master', null, null, '', $arrField);
?>
<div>
	<ul class="breadcrumb">
		<li>
...
<div class="row-fluid sortable">		
	<div class="box span12">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-eye-open"></i> Area</h2>
			...
			<table class="table table-striped table-bordered bootstrap-datatable datatable">
				...
				<tbody>
					...
					for ($intIndex = 0; $intIndex < count($arrRecords); $intIndex++)
					{
						?>
						<tr>
							<td><?php echo $arrRecords[$intIndex]['area_name']; ?></td>
							...
							<td class="center">
								...
								<a class="btn btn-info" href="create_city.php?city_id=<?php echo $arrRecords[$intIndex]['area_id']; ?>">
									<i class="icon-edit icon-white"></i>  
									Edit                                            
								</a>
								
								<a class="btn btn-danger" href="#" onclick="updateRecord('city_master','<?php echo $arrRecords[$intIndex]['area_id']; ?>','city_id');">
