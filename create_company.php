				...
				<table class="table table-striped table-bordered bootstrap-datatable" id="mytable" name="mytable">
						...
						<tbody>	
							...
							<tr id="visibleDiv" name="visibleDiv">
								<td class="center"><input class="input-small focused required" id="contact_full_name" name="contact_full_name[]" type="text" value="<?php echo (isset($arrCompanyContactData[$intIndex]['contact_full_name']) ? $arrCompanyContactData[$intIndex]['contact_full_name'] : ''); ?>"></td>
								<td class="center"><input type="text" class="input-small datepicker required" id="dob" name="dob[]" value="<?php echo (isset($arrCompanyContactData[$intIndex]['dob']) ? $arrCompanyContactData[$intIndex]['dob'] : ''); ?>"></td>
                                <td class="center"><label for="dom"><input type="text" class="input-small datepicker required" id="dom" name="dom[]"value="<?php echo (isset($arrCompanyContactData[$intIndex]['dom']) ? $arrCompanyContactData[$intIndex]['dom'] : ''); ?>"></td>
								<td class="center"><input class="input-small focused required" id="contact_mobile" name="contact_mobile[]" type="text" value="<?php echo (isset($arrCompanyContactData[$intIndex]['contact_mobile']) ? $arrCompanyContactData[$intIndex]['contact_mobile'] : ''); ?>"></td>
                                <td class="center"><input class="input-small focused required" id="contact_email" name="contact_email[]" type="email" value="<?php echo (isset($arrCompanyContactData[$intIndex]['contact_email']) ? $arrCompanyContactData[$intIndex]['contact_email'] : ''); ?>"></td>
